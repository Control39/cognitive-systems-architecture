...
class PortfolioGenerator:
    def __init__(
        ...
        progress_file: str = "portfolio-system-architect/components/it-compass/src/data/user_progress.json",
        output_file: str = "portfolio-system-architect/components/it-compass/docs/my_portfolio.md",
    ):
