# 05 Documentation Docs Obsidian Map Docs Obsidian Map Docs Methodology Markers Cybersecurity

- **Путь**: `05_DOCUMENTATION\obsidian-map\05_DOCUMENTATION_docs_obsidian-map_docs_obsidian-map_docs_methodology_markers_cybersecurity.md`
- **Тип**: .MD
- **Размер**: 993 байт
