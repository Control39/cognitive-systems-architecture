# 05 Documentation Docs Obsidian Map Docs Obsidian Map Components Career Development System Src Utils Helpers

- **Путь**: `05_DOCUMENTATION\obsidian-map\05_DOCUMENTATION_docs_obsidian-map_docs_obsidian-map_components_career-development-system_src_utils_helpers.md`
- **Тип**: .MD
- **Размер**: 1,008 байт
