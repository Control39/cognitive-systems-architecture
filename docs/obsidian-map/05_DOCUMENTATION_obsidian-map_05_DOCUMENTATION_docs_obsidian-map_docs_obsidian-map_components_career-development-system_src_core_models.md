# 05 Documentation Docs Obsidian Map Docs Obsidian Map Components Career Development System Src Core Models

- **Путь**: `05_DOCUMENTATION\obsidian-map\05_DOCUMENTATION_docs_obsidian-map_docs_obsidian-map_components_career-development-system_src_core_models.md`
- **Тип**: .MD
- **Размер**: 1,000 байт
