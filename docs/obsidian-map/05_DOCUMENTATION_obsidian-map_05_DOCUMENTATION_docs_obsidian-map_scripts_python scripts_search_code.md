# 05 Documentation Docs Obsidian Map Scripts Python Scripts Search Code

- **Путь**: `05_DOCUMENTATION\obsidian-map\05_DOCUMENTATION_docs_obsidian-map_scripts_python scripts_search_code.md`
- **Тип**: .MD
- **Размер**: 889 байт
