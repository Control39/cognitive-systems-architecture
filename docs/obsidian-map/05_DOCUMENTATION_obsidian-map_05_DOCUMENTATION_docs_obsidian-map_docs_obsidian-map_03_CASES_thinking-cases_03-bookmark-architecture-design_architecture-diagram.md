# 05 Documentation Docs Obsidian Map Docs Obsidian Map 03 Cases Thinking Cases 03 Bookmark Architecture Design Architecture Diagram

- **Путь**: `05_DOCUMENTATION\obsidian-map\05_DOCUMENTATION_docs_obsidian-map_docs_obsidian-map_03_CASES_thinking-cases_03-bookmark-architecture-design_architecture-diagram.md`
- **Тип**: .MD
- **Размер**: 1,040 байт
...
- **Путь**: `docs\obsidian-map\03_CASES_thinking-cases_03-bookmark-archi
... (файл продолжается)
```
